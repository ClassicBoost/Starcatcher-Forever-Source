	...
	public function setCharacter(x:Float, y:Float, character:String):Character
	{
		...
		switch (curCharacter)
		{
			...
			case 'old-ori':
				...
				animation.addByPrefix('singUP', 'ori up0', 24);
			...
			case 'evilori':
				...
				tex = Paths.getSparrowAtlas('characters/evilori');
				frames = tex;
				animation.addByPrefix('idle', 'evilori idle0', 24, false);
				animation.addByPrefix('singUP', 'evilori up0', 24);
			...
			case 'old-shriek':
				...
				tex = Paths.getSparrowAtlas('characters/OLDshriek');
				frames = tex;
				animation.addByPrefix('idle', 'shriek idle0', 24, false);
				animation.addByPrefix('singUP', 'shriek up0', 24);
				animation.addByPrefix('singRIGHT', 'shriek right0', 24);
				animation.addByPrefix('singDOWN', 'shriek down0', 24);
				animation.addByPrefix('singLEFT', 'shriek left0', 24);

				setGraphicSize(Std.int(width * 3.1)); // he used to be 3.5 but it changed, probably because the scale was breaking the stage.
