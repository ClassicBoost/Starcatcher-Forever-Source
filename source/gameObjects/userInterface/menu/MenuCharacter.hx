...
class MenuCharacter extends FlxSprite
{
	...
	var curCharacterMap:Map<String, Array<Dynamic>> = [
		...
		'dad' => ["Dad idle dance BLACK LINE", 24, true, 1 * 0.5, 0, -120],
		'spooky' => ["spooky dance idle BLACK LINES", 24, true, 1 * 0.5, 0, 40],
		'pico' => ["Pico Idle Dance", 24, true, 1 * 0.5, 0, -120],
		'mom' => ["Mom Idle BLACK LINES", 24, true, 1 * 0.5, 0, -220],
